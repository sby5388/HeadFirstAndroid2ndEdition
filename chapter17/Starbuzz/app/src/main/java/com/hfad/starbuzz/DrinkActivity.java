    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.toast).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast toast = Toast.makeText(DrinkActivity.this, "", Toast.LENGTH_SHORT);
                View view = getLayoutInflater().inflate(R.layout.view, new LinearLayout(DrinkActivity.this), false);
                toast.setView(view);
                toast.show();
            }
        });
